...
export function InteractionLogsModal({ isOpen, onClose, targetId, targetName }: InteractionLogsModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh]">
        ...
        {!loading && !error && logs.length === 0 && (
          <div className="text-muted-foreground text-center py-8">No recent item or money interactions found.</div>
        )}
